...
const communityHighlights = [
  {
    ...
    description:
      'Debates moderados, resolución de dudas y feedback directo de la comunidad.',
    icon: 'fas fa-comments',
  },
  {
    title: 'Proyectos colaborativos',
    description:
      'Encuentra equipo para lanzar MVPs o únete a iniciativas en marcha.',
    icon: 'fas fa-project-diagram',
  },
  {
    title: 'Mentorías en vivo',
    description:
      'Sesiones mensuales con especialistas en SEO, producto y desarrollo.',
    icon: 'fas fa-chalkboard-teacher',
  },
  {
    title: 'Recursos exclusivos',
    description:
      'Plantillas, checklists y flujos de trabajo compartidos por la comunidad.',
    icon: 'fas fa-toolbox',
  },
];
      ...
      <section className="pointer-events-none blur-sm">
        <div className="container mx-auto max-w-6xl px-6 py-20 text-center">
          ...
          <p className="mt-4 text-lg text-text-muted md:text-xl">
            Un punto de encuentro para makers, marketers y developers que crean
          ...
          <div className="mt-12 rounded-2xl border border-card-bg bg-card-bg/80 p-8 text-center shadow-lg shadow-black/20">
            ...
            <p className="mt-3 text-text-muted">
              Anúnciate para recibir novedades, ventajas de fundadores y acceso
              anticipado a los espacios de colaboración.
            </p>
