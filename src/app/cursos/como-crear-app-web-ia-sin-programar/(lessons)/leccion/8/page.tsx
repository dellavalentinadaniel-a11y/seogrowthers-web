...
const quizQuestions = [
  {
    id: 'q1',
    prompt:
      '1. En nuestro escenario de Make, ¿cuál es la función principal del primer módulo “Webhook”?',
    options: [
      { id: 'a', label: 'Enviar un email de notificación.' },
      {
        id: 'b',
        label: 'Esperar y recibir los datos que envía nuestra app de Bubble.',
      },
  ...
  },
  {
    id: 'q2',
    prompt:
      '2. ¿En qué parte del módulo de OpenAI pegamos la “Instrucción Maestra”?',
    options: [
  ...
  },
  {
    id: 'q3',
    prompt:
      '3. ¿Por qué es seguro usar nuestra API Key de OpenAI dentro de Make?',
    options: [
      {
        id: 'a',
        label:
          'Porque Make almacena la API Key encriptada y no se expone en nuestra web.',
      },
