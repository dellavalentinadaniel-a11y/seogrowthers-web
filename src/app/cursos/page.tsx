...
const miniProjects = [
  {
    ...
    description:
      'Construye la base de una tienda online funcional con Next.js.',
    href: '#',
  },
  {
    ...
    <main className="container mx-auto max-w-7xl px-4 py-16 text-text-light sm:px-6 lg:px-8">
      <header className="mx-auto mb-16 max-w-3xl text-center">
        ...
        <p className="mt-4 text-lg text-text-muted">
          Contenido práctico, enfoque en productos y soporte constante para que
          avances desde la idea hasta el lanzamiento.
        </p>
      </header>
          ...
          return (
            <article
              ...
              className={[
                ...
                isPrimary
                  ? 'border-text-accent/70'
                  : 'border-card-bg hover:border-text-accent/40',
              ].join(' ')}
            >
              ...
              <p className="mt-4 flex-grow text-text-light/80">
                {course.description}
              </p>
        ...
        <div className="flex flex-wrap items-end justify-between gap-4">
          <div>
            <h2 className="text-3xl font-bold text-white">
              Mini-proyectos adicionales
            </h2>
            <p className="mt-2 text-text-muted">
              Ejercicios cortos para reforzar habilidades específicas y
              practicar stacks distintos.
            </p>
          </div>
        </div>
        <div className="mt-8 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
          {miniProjects.map(project => (
            ...
            >
              ...
              <p className="mt-3 flex-grow text-sm text-text-muted">
                {project.description}
              </p>
              <a
                href={project.href}
