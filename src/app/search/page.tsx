    ...
    return (
      <section className="container mx-auto flex min-h-[60vh] max-w-4xl flex-col items-center justify-center px-6 text-center text-text-light">
        ...
        <p className="mt-4 text-lg text-text-muted">
          Escribe un término en la barra superior para descubrir artículos,
          guías y cursos relacionados.
        </p>
      </section>
    );
  }
      ...
      <header className="mb-10">
        ...
        {!hasResults && (
          <p className="mt-4 text-text-muted">
            No encontramos coincidencias. Ajusta el término o prueba con un
            sinónimo.
          </p>
        )}
      </header>
