...
const quizQuestions = [
  {
    question:
      'Según el curso, ¿cuál es la mentalidad principal que debe adoptar un creador No-Code + AI?',
    options: [
      'Mentalidad de Programador',
      'Mentalidad de Diseñador',
      'Mentalidad de Integrador',
    ],
    correctAnswer: 2,
    explanation:
      'Tu trabajo principal es conectar herramientas y servicios existentes, como un integrador.',
  },
  {
    question: '¿Qué es una API, según la analogía usada en el curso?',
    options: [
      'Un lenguaje de programación',
      'Un mesero que comunica tu app con la IA',
      'La interfaz visual de la app',
    ],
    correctAnswer: 1,
    explanation:
      'La API actúa como un intermediario (mesero) que lleva las peticiones de tu app a la IA y te trae la respuesta.',
  },
  {
    question: '¿Cuál es el rol del "Frontend" en nuestra arquitectura?',
    options: [
      'Es el cerebro de la IA (ej. OpenAI)',
      'Es la herramienta que conecta todo (ej. Make)',
      'Es la interfaz que el usuario ve y usa (ej. Bubble)',
    ],
    correctAnswer: 2,
    explanation:
      'El Frontend es la "cara" de tu aplicación, donde los usuarios interactúan.',
  },
];
  ...
  return (
    <div className="not-prose my-12 rounded-2xl border border-card-bg bg-card-bg/80 p-6 text-text-light shadow-lg shadow-black/20 md:p-8">
      ...
      <p className="mt-2 text-text-muted">
        Pon a prueba los conceptos clave de la introducción.
      </p>
